...
export const ROUTER_ADDRESS =
  parseInt(process.env.REACT_APP_CHAIN_ID) === ChainId.MAINNET
    ? '0x10ED43C718714eb63d5aA57B78B54704E256024E'
    : '0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3'

export const BATH_MASTER_ADDRESS =
  parseInt(process.env.REACT_APP_CHAIN_ID) === ChainId.MAINNET
    ? '0x5F4a4DbF43756b2Ae4413a935C7B1D00CD0D5E3f'
    : '0x5F4a4DbF43756b2Ae4413a935C7B1D00CD0D5E3f'

export const PRESALE_MASTER_ADDRESS =
  parseInt(process.env.REACT_APP_CHAIN_ID) === ChainId.MAINNET
    ? '0x86B16D8bbF2368CFE206c737FCDF4f948af642F8'
    : '0x6E96a9848E92eBaCd1988bfbF8236f543691efC5'

export const SNFTD_DUMMY_ADDRESS =
  parseInt(process.env.REACT_APP_CHAIN_ID) === ChainId.MAINNET
    ? '0xf1b0f15a8baed8a82f38993f63d26f288dfc01e8'
    : '0xf1b0f15a8baed8a82f38993f63d26f288dfc01e8'
